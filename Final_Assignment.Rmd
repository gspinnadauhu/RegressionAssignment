...
Based on the p-value of 0.0007, we reject the H0, and conclude that the mean mpg for manual transmission cars is less than for automatic cars.
...
We also find that cyl, wt and disp are highly correllated between the other variables. This could lead to some multicollinearity when running the regression. We will make the determination if some of these should be excluded based on variance inflation factors.
