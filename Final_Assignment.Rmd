...
In the restricted model, the adjusted R-sq is roughly the same as in the unrestricted model. Coefficients for hp and wt are now highly significant at p=0.05.
